...
var invoice_storage = multer.diskStorage({
  ...
  filename: (req,file,cb) => {
    console.log(file)
    f_name = `invoice_${new Date().format('yyyymmddHHMMss')}_${file.originalname}`
    console.log(f_name)
    cb(null, f_name )
  }
...
var maintain_report_storage = multer.diskStorage({
  ...
  filename: (req,file,cb) => {
    console.log(file)
    f_name =  `maintain_${new Date().format('yyyymmddHHMMss')}_${file.originalname}`
    console.log(f_name)
    cb(null, f_name )
  }
})
var items_storage = multer.diskStorage({
  ...
  filename: (req,file,cb) => {
    console.log(file)
    f_name =  `items_${new Date().format('yyyymmddHHMMss')}_${file.originalname}`
    console.log(f_name)
    cb(null, f_name )
  }
})
